...
### Lecture Slides [as a Website](https://bayesian-econometrics-2023.github.io/be23-lecture8/) {style="color:#ffd700;"}

### Quarto [document template](https://github.com/Bayesian-Econometrics-2023/be23-lecture8/blob/main/be23-lecture8.qmd) for your own Australian monetary policy analysis{style="color:#ffd700;"}

### GitHub [repo](https://github.com/Bayesian-Econometrics-2023/be23-lecture8) to reproduce the slides and results{style="color:#ffd700;"}
...
## [bsvars:](https://cran.r-project.org/package=bsvars) <span style="color: #ffd700;">Bayesian Estimation of Structural Vector Autoregressive Models</span> {background-color="#ff69b4"}
